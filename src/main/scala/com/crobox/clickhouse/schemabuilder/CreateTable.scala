...
/**
  ...
  * @since 30-12-16
  */
case class CreateTable(tableName: String, columns: Seq[Column], engine: Engine,
                       ifNotExists: Boolean = false,
                       databaseName: String = ClickhouseStatement.DefaultDatabase) extends ClickhouseSchemaStatement {
