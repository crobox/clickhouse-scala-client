...
trait ClickhouseTokenizerModule extends LazyLogging with TokenizerModule {
  ...
  private def tokenizeWhere(maybeCondition: Option[query.Comparison]): String =
