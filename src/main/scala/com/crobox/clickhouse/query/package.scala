...
import com.crobox.clickhouse.query.clickhouse.{QueryValue, QueryValueFormats}

import scala.collection.immutable.Iterable
import scala.collection.mutable

package object query extends ColumnOperations with QueryValueFormats {
  ...
  implicit class NegatedStringConditions[T <: Table](negated: NegateColumn[T, String])
  ...
  implicit class NegatedConditions[T <: Table, V](negated: NegateColumn[T, V])
  ...
  case class NegateColumn[T <: Table, V](column: TableColumn[V])

  implicit class NegateComparison[T <: Table, V](column: TableColumn[V]) {

    def not(): NegateColumn[T, V] =
      NegateColumn(column)
  }
