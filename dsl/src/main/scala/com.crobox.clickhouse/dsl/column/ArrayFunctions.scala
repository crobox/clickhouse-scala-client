...
trait ArrayFunctions { this: Magnets =>
  ...
  case class ArrayResize[V](col: ArrayColMagnet[_ <: Iterable[V]], size: NumericCol[_], extender: ConstOrColMagnet[V]) extends ArrayFunctionOp[Iterable[V]]
  ...
  def hasAll(col: ArrayColMagnet[_], elm: ArrayColMagnet[_]) = HasAll(col, elm)
  def hasAny(col: ArrayColMagnet[_], elm: ArrayColMagnet[_]) = HasAny(col, elm)
  ...
  def arrayResize[V](col: ArrayColMagnet[_ <: Iterable[V]], size: NumericCol[_], extender: ConstOrColMagnet[V]) = ArrayResize[V](col, size, extender)
