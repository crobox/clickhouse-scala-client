...
//    }
  ...
  implicit def InFuncRHMagnetFromIterable[T : QueryValue](s: Iterable[T])(implicit c: ClassTag[T]): InFuncRHMagnet =
    new InFuncRHMagnet {
      val qvT = implicitly[QueryValue[T]]
      val sConsts: Seq[ConstOrColMagnet[T]] = s.map(col => constOrColMagnetFromConst(col)(qvT)).toSeq
  ...
  implicit def arrayColMagnetFromIterable[T : QueryValue](s: Iterable[T])(implicit c: ClassTag[T]): ArrayColMagnet[Iterable[T]] =
  ...
  implicit def stringColMagnetFromString[T <: String : QueryValue](s: T)(implicit c: ClassTag[T]): StringColMagnet[String] =
    new StringColMagnet[String] {
      override val column: TableColumn[String] = Const(s)
    }

  implicit def stringColMagnetFromStringCol[T <: TableColumn[String]](s: T)(implicit c: ClassTag[T]): StringColMagnet[String] =
    new StringColMagnet[String] {
      override val column: TableColumn[String] = s
    }

  implicit def stringColMagnetFromUUID[T <: UUID : QueryValue](s: T)(implicit c: ClassTag[T]): StringColMagnet[UUID] =
    new StringColMagnet[UUID] {
      override val column: TableColumn[UUID] = Const(s)
    }

  implicit def stringColMagnetFromUUIDCol[T <: TableColumn[UUID]](s: T)(implicit c: ClassTag[T]): StringColMagnet[UUID] =
    new StringColMagnet[UUID] {
  ...
  implicit def ddtFromDate[T <: LocalDate : QueryValue](s: T)(implicit c: ClassTag[T]): DateOrDateTime[LocalDate] =
    new DateOrDateTime[LocalDate] {
      override val column = toDate(s)
    }

  implicit def ddtFromDateTime[T <: DateTime : QueryValue](s: T)(implicit c: ClassTag[T]): DateOrDateTime[DateTime] =
    new DateOrDateTime[DateTime] {
  ...
  implicit def numericFromLong[T <: Long : QueryValue](s: T)(implicit c: ClassTag[T]): NumericCol[Long] =
    new NumericCol[Long] {
      override val column = Const(s)
    }

  implicit def numericFromInt[T <: Int : QueryValue](s: T)(implicit c: ClassTag[T]): NumericCol[Int] =
    new NumericCol[Int] {
      override val column = Const(s)
    }

  implicit def numericFromDouble[T <: Double : QueryValue](s: T)(implicit c: ClassTag[T]): NumericCol[Double] =
    new NumericCol[Double] {
      override val column = Const(s)
    }

  implicit def numericFromFloat[T <: Float : QueryValue](s: T)(implicit c: ClassTag[T]): NumericCol[Float] =
    new NumericCol[Float] {
      override val column = Const(s)
    }

  implicit def numericFromBigInt[T <: BigInt : QueryValue](s: T)(implicit c: ClassTag[T]): NumericCol[BigInt] =
    new NumericCol[BigInt] {
      override val column = Const(s)
    }

  implicit def numericFromBigDecimal[T <: BigDecimal : QueryValue](s: T)(implicit c: ClassTag[T]): NumericCol[BigDecimal] =
    new NumericCol[BigDecimal] {
      override val column = Const(s)
    }

  implicit def numericFromBoolean[T <: Boolean : QueryValue](s: T)(implicit c: ClassTag[T]): NumericCol[Boolean] =
    new NumericCol[Boolean] {
      override val column = Const(s)
    }

  implicit def numericFromLongCol[T <: TableColumn[Long]](s: T)(implicit c: ClassTag[T]): NumericCol[Long] =
    new NumericCol[Long] {
      override val column = s
    }

  implicit def numericFromIntCol[T <: TableColumn[Int]](s: T)(implicit c: ClassTag[T]): NumericCol[Int] =
    new NumericCol[Int] {
      override val column = s
    }

  implicit def numericFromDoubleCol[T <: TableColumn[Double]](s: T)(implicit c: ClassTag[T]): NumericCol[Double] =
    new NumericCol[Double] {
      override val column = s
    }

  implicit def numericFromFloatCol[T <: TableColumn[Float]](s: T)(implicit c: ClassTag[T]): NumericCol[Float] =
    new NumericCol[Float] {
      override val column = s
    }

  implicit def numericFromBigIntCol[T <: TableColumn[BigInt]](s: T)(implicit c: ClassTag[T]): NumericCol[BigInt] =
    new NumericCol[BigInt] {
      override val column = s
    }

  implicit def numericFromBigDecimalCol[T <: TableColumn[BigDecimal]](s: T)(implicit c: ClassTag[T]): NumericCol[BigDecimal] =
    new NumericCol[BigDecimal] {
      override val column = s
    }

  implicit def numericFromBooleanCol[T <: TableColumn[Boolean]](s: T)(implicit c: ClassTag[T]): NumericCol[Boolean] =
    new NumericCol[Boolean] {
      override val column = s
    }
