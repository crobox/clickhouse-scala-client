...
trait ArithmeticFunctions { self: Magnets =>
  ...
  implicit object LongIntBinding        extends AritRetType[Long, Int, Long]
  ...
  implicit object DoubleFloatBinding      extends AritRetType[Double, Float, Double]
  ...
  implicit object FloatDoubleBinding     extends AritRetType[Float, Double, Double]
